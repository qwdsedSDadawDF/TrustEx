if LPH_OBFUSCATED == nil then
    ...
    LPH_CRASH = function(...)
        warn("LPH_CRASH blocked")
        return
    end
    LRM_IsUserPremium = false
    LRM_LinkedDiscordID = "915035803728621578"
    LRM_ScriptName = "TrustEx Market"
...
if getgenv().trustex_loaded then
    return
end

getgenv().trustex_loaded = true
...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.Players.LocalPlayer:Kick("TrustEx Market | Security : You are running another script, please disable it and execute again")
    end
end
...
do -- FrameWork
    ...
    Config.HideScreen = LPH_JIT_MAX(function(Self, Title)
        ...
        textLabel.Text = '<font color="' .. accentString .. '">TrustEx Market</font>\n' .. Title
    ...
    Config.SetText = LPH_JIT_MAX(function(Self, Text)
        if Black_UI then
            ...
            Black_UI["\nhideuiTrustEx"].Text = '<font color="' .. accentString .. '">TrustEx Market</font>\n' .. Text
        end
    end)
...
local Options, MiscOptions do
    ...
    MiscOptions = {
        ...
        ["Boxes"] = false;
        ["BoxType"] = "Corner";
        ["Box Gradient 1"] = { Color = rgb(50, 125, 255), Transparency = 0.9 };
        ...
        ["Healthbar_Low"] = { Color = rgb(50, 125, 255), Transparency = 1};
            ...
            local Items = Data.Items; do
                ...
                -- Healthbar
                    ...
                    Items.HealthbarGradient = Esp:Create( "UIGradient" , {
                        ...
                        Rotation = 90;
                        Color = rgbseq{rgbkey(0, rgb(0, 255, 0)), rgbkey(0.5, rgb(255, 125, 0)), rgbkey(1, rgb(50, 125, 255))}
                    });
...
do -- Library
    ...
    local Themes = {
        ["Preset"] = {
            ...
            ["Accent"] = Color3.fromRGB(0,125,255),          -- Blue accent (like "bronx")
        ...
        ["Bitch Bot"] = {
            ...
            ["Accent"] = Color3.fromRGB(0,125,255),        -- from #7e48a3
        ...
        ["Roobet"] = {
            ...
            ["Accent"] = Color3.fromRGB(0,125,255),         -- Roobet yellow accent (#FFCC00)
        ...
        ["Twitch"] = {
            ...
            ["Accent"] = Color3.fromRGB(0,125,255), -- Twitch purple
        ...
        ["One Tap"] = {
            ...
            ["Accent"] = Color3.fromRGB(0,125,255),         -- from #edaa00
    ...
    Library.ChangeTheme = LPH_NO_VIRTUALIZE(function(self, Theme, Color)
        ...
        if Theme == "Accent" and Window then
            Window:SetText(string.format(
                '<font color="rgb(255,255,255)">TrustEx Market</font><font color="rgb(%d,%d,%d)">gg</font> | %s',
                Color.R*255,
                Color.G*255,
                Color.B*255,
            ...
            Watermark:SetText(string.format('<font color="rgb(255,255,255)">TrustEx Market</font><font color="rgb(%d,%d,%d)">gg</font> - %s - %s',Color.R*255,Color.G*255,Color.B*255, Game_Name_MarketPlaceService, os.date("%b. %d %Y, %X")))
        end
...
do
    Window = Library:Window({
        Name = '<font color="rgb(255,255,255)">TrustEx Market</font><font color="rgb(50, 125, 255)">gg</font> | '..Game_Name_MarketPlaceService,
        Version = "v1.0.0",
    ...
    local Special_DiscordIDS = {
        ["1096603799159832636"] = ' - <font color="#327DFF">Owner</font>'
    }
    ...
    task.spawn(LPH_NO_VIRTUALIZE(function()
        while task.wait(1) do
            Watermark:SetText(string.format('<font color="rgb(255,255,255)">TrustEx Market</font><font color="rgb(%d,%d,%d)">gg</font> - %s - %s',Library.Theme.Accent.R*255,Library.Theme.Accent.G*255,Library.Theme.Accent.B*255, Game_Name_MarketPlaceService, os.date("%b. %d %Y, %X")))
        end
    end))
        ...
        do -- Combat
            ...
            do -- Selector
                ...
                do
                    ...
                    _Toggle:Colorpicker({Name="Highlight Filled Color", Default = Color3.fromRGB(0,125,255), Alpha=0.6,Callback=function(Color,Transparency)
        ...
        do -- Main
            ...
            do -- Vehicles
                do -- Modifications
                    ...
                    VehicleSection:Toggle({Name = "TrustExcity Speed Enabled", Flag = "TrustExcitySpeed_Enabled", Default = false, Callback = function(State)
                        Config.VehicleModifications.SpeedEnabled = State
                    end})

                    VehicleSection:Slider({Name = "Speed Value", Min = 1, Max = 25, Default = 5, Flag = "TrustExcitySpeed_Value", Suffix = "s/ps", Decimals = 1, Callback = function(State)
                        Config.VehicleModifications.SpeedValue = State/1000
                    end})

                    VehicleSection:Toggle({Name = "Break TrustExcity Enabled", Flag = "BreakVelocity_Enabled", Default = false, Callback = function(State)
